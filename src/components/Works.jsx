      ...
      >
        <div className="relative w-full h-[230px] sm:h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-2 sm:m-3 card-img_hover">
            ...
            >
              {/* Add an icon or text for source code */}
            </div>
          </div>
        </div>
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        "My certifications showcase a diverse range of expertise, demonstrating a deep understanding of industry-standard tools and techniques. They reflect my commitment to continuous learning and staying updated with the latest trends and technologies in the field."
        </motion.p>
      </div>
